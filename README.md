...
| <a name="input_db_seqera_password"></a> [db\_seqera\_password](#input\_db\_seqera\_password) | Password for the Seqera DB user. | `string` | `""` | no |
| <a name="input_db_seqera_username"></a> [db\_seqera\_username](#input\_db\_seqera\_username) | The username for the database. | `string` | `"seqera"` | no |
...
| <a name="input_seqera_namespace"></a> [seqera\_namespace](#input\_seqera\_namespace\_name) | Kubernetes namespace used to deploy Seqera platform manifests. | `string` | `"seqera-platform"` | no |
...
| <a name="input_seqera_service_account_name"></a> [seqera\_service\_account\_name](#input\_seqera\_service\_account\_name) | Kubernetes service account used to deploy Seqera platform | `string` | `"seqera-sa"` | no |
