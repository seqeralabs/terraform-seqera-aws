...
| <a name="input_ec2_instan_security_group_ingress_rules_names"></a> [ec2\_instan\_security\_group\_ingress\_rules\_names](#input\_ec2\_instan\_security\_group\_ingress\_rules\_names) | The names of the security group ingress rules. | `list(string)` | <pre>[<br>  "http-80-tcp",<br>  "https-443",<br>  "smtp-tcp"<br>]</pre> | no |
