...
| <a name="input_db_password"></a> [db\_password](#input\_db\_password) | Database password used by Seqera platform. | `string` | `""` | no |
| <a name="input_db_username"></a> [db\_username](#input\_db\username) | Database username used by Seqera platform. | `string` | `"seqera"` | no |
