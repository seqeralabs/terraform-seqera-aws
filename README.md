...
| [aws_ami.ubuntu](https://registry.terraform.io/providers/hashicorp/aws/5.0.0/docs/data-sources/ami) | data source |
...
| <a name="input_ec2_instan_security_group_ingress_rules_names"></a> [ec2\_instan\_security\_group\_ingress\_rules\_names](#input\_ec2\_instan\_security\_group\_ingress\_rules\_names) | The names of the security group ingress rules. | `list(string)` | <pre>[<br>  "http-80-tcp",<br>  "https-443-tcp",<br>  "smtp-tcp"<br>]</pre> | no |
...
| <a name="input_ec2_instance_type"></a> [ec2\_instance\_type](#input\_ec2\_instance\_type) | The type of the EC2 instance. | `string` | `"t3.micro"` | no |
