...
| <a name="input_vpc_endpoint_services"></a> [vpc\_endpoint\_services](#input\_vpc\_endpoint\_services) | The list of VPC endpoint services. | `set(string)` | <pre>[<br>  "ssm",<br>  "ssmmessages",<br>  "ec2messages"<br>]</pre> | no |
