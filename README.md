...
| <a name="input_create_seqera_configmap"></a> [create\_seqera\_configmap](#input\_create\_seqera\_configmap) | Determines whether to create the Seqera ConfigMap. | `bool` | `true` | no |
...
| <a name="input_seqera_configmap_name"></a> [seqera\_configmap\_name](#input\_seqera\_configmap\_name) | The name of the ConfigMap used to deploy Seqera platform manifests. | `string` | `"seqera-configmap"` | no |
...
| <a name="input_tower_db_driver"></a> [tower\_db\_driver](#input\_tower\_db\_driver) | The JDBC driver for the Tower database | `string` | `"org.mariadb.jdbc.Driver"` | no |
