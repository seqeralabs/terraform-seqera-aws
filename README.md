...
| [local_file.output_file](https://registry.terraform.io/providers/hashicorp/local/2.4.0/docs/resources/file) | resource |
...
| <a name="input_create_output_file"></a> [create\_output\_file](#input\_create\_output\_file) | Determines whether to send Terraform output values to a file. | `bool` | `false` | no |
...
| <a name="input_output_file_name"></a> [output\_file\_name](#input\_output\_file\_name) | The name of the file to send Terraform output values to. | `string` | `"terraform-output.txt"` | no |
| <a name="input_output_file_path"></a> [output\_file\_path](#input\_output\_file\_path) | The path to the file to send Terraform output values to. | `string` | `"."` | no |
| <a name="input_output_file_permissions"></a> [output\_file\_permissions](#input\_output\_file\_permissions) | The permissions for the file to send Terraform output values to. | `number` | `644` | no |
