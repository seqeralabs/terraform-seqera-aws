...
variable "alb_controller_service_account_name" {
  type = string
  description = "Name for the ALB controller service account"
  default = "alb-controller-sa"
}

variable "alb_controller_service_account_iam_policy" {
  type = string
...
variable "alb_controller_iam_policy_name" {
  type = string
  description = "The name of the IAM policy for the ALB controller."
  default = "alb-controller-iam-policy"
}
